...
int main(int argc, char *argv[]) {
    ...
    // copy data from host to GPU and then copy the results back to host 
  // Create space for the listed variables and release it at the end of the region, but do not copy to
or from the device.
